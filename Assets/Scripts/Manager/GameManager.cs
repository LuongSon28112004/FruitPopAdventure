...
public class GameManager : BaseMonoBehaviour
{
    ...
    [SerializeField]
    private WinPanelManager winPannelManager;
    ...
    public WinPanelManager WinPannelManager
    {
        get => winPannelManager;
        set => winPannelManager = value;
    }
    ...
    protected override void Awake()
    {
        ...
        if (winPannelManager == null)
            winPannelManager = transform.Find("WinPanelManager").GetComponent<WinPanelManager>();
        if (instance == null)
            instance = this;
    }
    ...
    void OnEnable()
    {
        cellItemManager.OnWinGame += (score) => WinPannelManager.ShowWin(score);
    }
